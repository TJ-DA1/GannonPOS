...
Total - The price value of all items in the queue will be added to the total displayed above the item queue. This avoids manual calculation. Items that do not exist in the database will contribute nothing to the total.
